...
class DestinationDao {
  const DestinationDao();

  Future<void> insert(Destination destinaion) async {
    final Database db = await AppDatabase().database;
    await db.insert('destinations', destinaion.toMap());
  }
  ...
  Future<List<Destination>> fectchAll() async {
    final Database db = await AppDatabase().database;
