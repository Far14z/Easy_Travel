...
import 'package:easy_travel/features/home/presentation/widgets/review_raiting.dart';
    ...
    showDialog(
      ...
      builder: (_) => AlertDialog(
        actions: [
          ...
          FilledButton(
            onPressed: () {
              context.read<ReviewBloc>().add(SubmitReview(id: destination.id, comment: comment, rating: rating));
